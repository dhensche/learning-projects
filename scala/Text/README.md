...
[**Reverse a String**](src/main/scala/text/ReverseAString.scala) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](src/main/scala/text/PigLatin.scala) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](src/main/scala/text/CountVowels.scala) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

[**Check if Palindrome**](src/main/scala/text/Palindrome.scala) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

[**Count Words in a String**](src/main/scala/text/CountWords.scala) – Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.
