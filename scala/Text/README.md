...
[**Reverse a String**](src/main/scala/ReverseAString.scala) – Enter a string and the program will reverse it and print it out.

[**Pig Latin**](src/main/scala/PigLatin.scala) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

[**Count Vowels**](src/main/scala/CountVowels.scala) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.
